    ...
    public partial class InitSpecialization : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OfficeTranslations", x => x.Id);
                    table.ForeignKey(
                        name: "FK_OfficeTranslations_Offices_OfficeId",
                        column: x => x.OfficeId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IssuingInstitution = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OfficeTranslations_OfficeId",
                table: "OfficeTranslations",
                column: "OfficeId");
